...
st.set_page_config(layout="wide", page_icon="🔮", page_title="EquiBot 🔮")
...
if not user_api_key:
    ...
    if uploaded_file:
        ...
        with st.form(key="query"):
            ...
            query = st.text_input("**Esta funcionalidade utiliza [PandasAI]**", value="", type="default",
                placeholder="e-g : quantas linhas ? "
                )
            submitted_query = st.form_submit_button("Gerar")
        ...
        if st.session_state.df is not None:
            st.subheader("Quadro de dados atual:")
